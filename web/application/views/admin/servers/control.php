<?php echo $header ?>
				...
				<form action="#" id="editForm" method="POST">
					<div class="form-group row">
						<label for="slots" class="col-sm-3 col-form-label">Количество слотов:</label>
						<div class="col-sm-3">
							<div class="input-group">
							  <div class="input-group-prepend" id="button-addon3">
								<button class="btn btn-outline-secondary" type="button" onclick="minusSlots()">-</button>
							  </div>
							  <input type="text" class="form-control text-center" id="slots" name="slots" value="<?php echo $server['server_slots'] ?>">
					...
					<div class="form-group row">
						...
						<div class="col-sm-4">
							<input type="password" class="form-control" id="password" name="password" statsGraph="Введите пароль" disabled>
						</div>
					</div>
					<div class="form-group row">
						<label for="password2" class="col-sm-3 col-form-label">Повтор пароля:</label>
						<div class="col-sm-4">
							<input type="password" class="form-control" id="password2" name="password2" statsGraph="Повторите пароль" disabled>
						</div>
					</div>
					<div class="form-group row">
						<div class="offset-sm-3 col-sm-9">
